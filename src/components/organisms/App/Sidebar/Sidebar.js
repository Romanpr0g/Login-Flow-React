  ...
  return (
    <aside className="sidebar">
      ...
      <ul className="menu__list">
        <li className={`menu__item ${location.pathname === "/" ? "active--menu" : "" }`}>
          <NavLink to="/" className="menu__link">
            <House />
            <span>Home</span>
          </NavLink>
        </li>
        <li className={`menu__item ${location.pathname === "/teams" ? "active--menu" : "" }`}>
          <NavLink to="/teams" className="menu__link">
            <Teams />
            <span>Teams</span>
          </NavLink>
        </li>
        <li className={`menu__item ${location.pathname === "/schedules" ? "active--menu" : "" }`}>
          <NavLink to="/schedules" className="menu__link">
            <Schedules />
            <span>Schedules</span>
          </NavLink>
        </li>
        <li className={`menu__item ${location.pathname === "/settings" ? "active--menu" : "" }`}>
